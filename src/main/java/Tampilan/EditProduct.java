...
public class EditProduct extends javax.swing.JDialog {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        try {
            ...
            PS.setInt(8, P.getId()); // Ambil ID dari produk yang diedit
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // Muat data dari Objek Produk (P) ke form
        txtKodeProduk.setText(P.getKodeProduk());
        txtNama.setText(P.getNama());
        txtKategori.setText(P.getKategori());
        txtStok.setText(String.valueOf(P.getStok()));
        txtHargaBeli.setText(P.getHargaBeli().toString());
        txtHargaJual.setText(P.getHargaJual().toString());
        
        selectedImagePath = P.getImagePath(); 
        if (selectedImagePath != null && !selectedImagePath.isEmpty()) {
            lblImagePath.setText(new File(selectedImagePath).getName());
        } else {
            lblImagePath.setText("Tidak ada gambar");
        }
